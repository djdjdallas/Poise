...
<AffiliateCard
  badge="For when your bio is working"
  title="Lovehoney — discreetly shipped, partner-friendly"
  description="If your bio's landing and conversations are heading somewhere, Lovehoney is the most-recommended store in the ENM community. Plain packaging, UK + US shipping, beginner-friendly product filters, 365-day returns."
  ctaText="Browse Lovehoney"
  url="REPLACE_WITH_LOVEHONEY_LINK"
  partner="lovehoney"
  placement="feeld-bio-mid"
/>
...
<AffiliateCard
  variant="inline"
  title="Recommended reading: The Ethical Slut"
  description="The book that established the modern ENM vocabulary. Most of the bio language you see in successful Feeld profiles traces back to it. Worth owning if you're new to non-monogamy."
  ctaText="See on Amazon"
  url="https://amzn.to/4iQAcFw"
  partner="amazon-ethical-slut"
  placement="feeld-bio-bottom"
/>
